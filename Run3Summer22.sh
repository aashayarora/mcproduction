...
EVENTS=${3:-10000}
NUMTHREADS=${4:-4}
FRAGMENT="GEN-Run3Summer22wmLHEGS-00067"
SEED=$(($(date +%s) % 100 + 1))
...
if [ ! -d /eos/user/a/aaarora/signal/Run3Summer22/${SAMPLE}_TuneCP5 ]; then
  mkdir -p /eos/user/a/aaarora/signal/Run3Summer22/${SAMPLE}_TuneCP5
fi

cp ${SAMPLE}-NanoAODv12.root /eos/user/a/aaarora/signal/Run3Summer22/${SAMPLE}_TuneCP5/$(uuidgen).root
